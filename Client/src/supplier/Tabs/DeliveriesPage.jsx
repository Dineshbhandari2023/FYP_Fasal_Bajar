...
export default function DeliveriesPage() {
  ...
  const { activeDeliveries, deliveryHistory, loading } = useSelector(
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          ...
          <div className="p-6">
            {loading ? (
              <div className="text-center py-8">
                <Truck className="h-12 w-12 mx-auto text-gray-300 animate-bounce" />
                <h3 className="mt-2 text-lg font-medium text-gray-500">
                  Loading deliveries...
                </h3>
              </div>
              ...
              <div className="space-y-6">
                {filteredDeliveries.map((delivery) => {
                  ...
                  const statusData = statusConfig[normalizedStatus];
                    ...
                    >
                      <div className="bg-gray-50 p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`p-2 rounded-full ${
                              statusData.color.split(" ")[0]
                            } bg-opacity-20`}
                          >
                            <StatusIcon
                              className={`h-5 w-5 ${
                                statusData.color.split(" ")[1]
                              }`}
                            />
                          </div>
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <span
                                className={`text-xs px-2 py-1 rounded-full ${statusData.color}`}
                              >
                                {statusData.label}
                              </span>
                            </div>
                      ...
                      <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="border rounded-md p-3">
                          ...
                          <p className="text-sm font-medium">
                            {delivery.OrderItem?.farmer?.username}
                          </p>
                          <p className="text-sm text-gray-500">
                        ...
                        <div className="border rounded-md p-3">
                          ...
                          <p className="text-sm font-medium">
                            {delivery.Order?.buyer?.username}
                          </p>
                          <p className="text-sm text-gray-500">
                            {delivery.Order?.buyer?.location}
                          </p>
                        </div>
                      </div>
                    </div>

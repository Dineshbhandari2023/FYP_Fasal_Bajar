...
// Import the new CustomRoutingMachine component
import CustomRoutingMachine from "./components/CustomRoutingMachine"
...
function RouteLayer({ pickupLocation, deliveryLocation, currentLocation }) {
  ...
  // Only render the routing machine if we have at least 2 waypoints
  return waypoints.length >= 2 ? (
    <CustomRoutingMachine waypoints={waypoints} color="blue" weight={4} opacity={0.6} />
  ) : null
}

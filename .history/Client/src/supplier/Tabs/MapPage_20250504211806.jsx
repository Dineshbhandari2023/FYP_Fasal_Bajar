...
import { getAllSuppliers, getActiveDeliveries } from "./supplierSlice";
import RealTimeLocationTracker from "./real-time-location-tracker";
...
export default function SupplierMapPage() {
  ...
  useEffect(() => {
    locationService
      ...
      .onConnect(() => {
        ...
        locationService.getActiveSuppliers();
      })
      .onDisconnect(() => {
      ...
      // Handle per-supplier live location updates
  ...
  return (
    <RealTimeLocationTracker trackingInterval={30000}>
      <div className="space-y-6 p-4 md:p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <h1 className="text-2xl font-bold tracking-tight">Supplier Map</h1>
          <div className="flex flex-wrap gap-2">
            <button
              className="px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-50 inline-flex items-center gap-2"
              onClick={centerOnCurrentLocation}
        ...
        <div className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm border">
          ...
          <div className="ml-auto text-sm text-gray-500">
            {Object.keys(realtimeSuppliers).length} active suppliers
          </div>
        </div>
        ...
        >
          {!isLoaded ? (
            ...
            >
              ...
              {/* Current location marker */}
              {currentLocation && (
                <Marker position={currentLocation} icon={activeSupplierIcon}>
                  <Popup>
                    <div className="text-center">
                      <strong>Your Current Location</strong>
                      <p className="text-xs text-gray-600">

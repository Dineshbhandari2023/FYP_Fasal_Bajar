...
export default function SupplierOrdersPage() {
  ...
  const normalized = availableDeliveries.map((d) => {
    ...
    return {
      ...
      items: `${oi.quantity} ${oi.Product.unit} ${oi.Product.productName}`,
      rawStatus: d.status,
      status: statusConfig[d.status]?.key || "new",
      date: d.createdAt,
      amount: `₹${oi.subtotal}`,
      orderItemId: d.id, // so you can accept it
      deliveryId: d.id, // or update status
    };
  });

...
// Make sure to import the new component at the top of your file
import MapboxDirectionsLayer from "./components/MapboxDirectionsLayer"
// Remove the import for leaflet-routing-machine
...
// Replace the RouteLayer component with this:
function RouteLayer({ pickupLocation, deliveryLocation, currentLocation }) {
  ...
  if (deliveryLocation) {
    waypoints.push(deliveryLocation)
  }

  // Only render the routing if we have at least 2 waypoints
  return waypoints.length >= 2 ? (
    <MapboxDirectionsLayer waypoints={waypoints} color="blue" weight={4} opacity={0.6} />
  ) : null
}
...
export default function SupplierMapPage() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          const defaultLocation = [26.660944, 87.280769] // Default center (Itahari, Nepal)
          ...
          // Display a toast or alert with the error message
      ...
      setIsLoaded(true)
      setMapCenter([26.660944, 87.280769]) // Default center
    }
  }, [])
  ...
  const getDeliveryLocations = () => {
    ...
    if (!deliveryLocation) {
      // For demo purposes, use a location near the current location
      if (currentLocation) {
        deliveryLocation = [currentLocation[0] + 0.01, currentLocation[1] + 0.01]
      } else {
  ...
  const centerOnCurrentLocation = () => {
    if (currentLocation) {
      ...
      const loadingToast = alert("Getting your location...")
            ...
            <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border">
              <div className="p-4 sm:p-6 border-b">
                ...
                <div className="flex mt-4 border-b overflow-x-auto">
                  ...
                  <button
                    className={`px-4 py-2 text-sm font-medium whitespace-nowrap ${
                      activeTab === "optimize" ? "border-b-2 border-green-600 text-green-600" : "text-gray-500"
                    }`}
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="p-3 border rounded-lg">
                    ...
                    <div className="text-lg font-bold">
                      {selectedDelivery?.estimatedDeliveryTime
                        ? new Date(selectedDelivery.estimatedDeliveryTime).toLocaleTimeString([], {
                            hour: "2-digit",
                            minute: "2-digit",
                          })
                        : "N/A"}
                  ...
                  <div className="p-3 border rounded-lg">
                    ...
                    <div className="text-lg font-bold">
                      {currentLocation && deliveryLocation ? "Calculating..." : "N/A"}
                    </div>
                  </div>
                  <div className="p-3 border rounded-lg">
                  ...
                  <div className="p-3 border rounded-lg">
                    ...
                    <div className="text-lg font-bold flex items-center">
                      <span
                        className={`h-2 w-2 rounded-full ${currentLocation ? "bg-green-500" : "bg-red-500"} mr-2`}
                      ></span>
                  ...
                  <div className="mt-4 p-4 border rounded-lg bg-gray-50">
                    ...
                    <ol className="space-y-2 pl-6 list-decimal">
                      <li className="text-sm">
                        <span className="font-medium">Pickup:</span> {selectedDelivery.pickupLocation?.address || "N/A"}
                      </li>
                      <li className="text-sm">

        ...
        try {
          ...
          if (routeLayersRef.current && routeLayersRef.current.length > 0) {
            routeLayersRef.current.forEach((layer) => {
              if (layer && map && map.hasLayer && typeof map.hasLayer === "function" && map.hasLayer(layer)) {
          ...
          if (routingControlRef.current && typeof routingControlRef.current.remove === "function") {

...
// import { clearSupplierState } from "./supplierSlice";
...
export const logoutUser = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      // Clear supplier state if exists
      // thunkAPI.dispatch(clearSupplierState());
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // Register Supplier
      .addCase(registerSupplierUser.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(registerSupplierUser.fulfilled, (state, action) => {
        state.loading = false;
        state.userInfo = action.payload.user_data;
      })
      .addCase(registerSupplierUser.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })

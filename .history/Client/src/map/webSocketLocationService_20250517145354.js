...
class WebSocketLocationService {
  ...
  connect(token) {
    ...
    // Connect to the location namespace with authentication
  ...
  // Register as a supplier to broadcast location
  ...
  updateLocation(
    ...
    if (!this.connected || !this.socket) {
      console.warn("Cannot update location: WebSocket not connected");
      return false;
    }
  ...
  // Mark supplier as offline
  setSupplierOffline(supplierId) {
    if (!this.connected || !this.socket) {
      console.warn("Cannot set offline: WebSocket not connected");
      return false;
    }

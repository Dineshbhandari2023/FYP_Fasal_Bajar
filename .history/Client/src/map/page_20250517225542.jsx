...
const SupplierMarkers = React.memo(
  ({
    suppliers,
    realtimeSuppliers,
    onMarkerClick,
...
const Map = () => {
  ...
  const accessToken = userState.accessToken || null;
  ...
  useEffect(() => {
    if (!accessToken) {
      setWsError("Please log in to view real-time tracking");
      navigate("/login");
    }
  ...
  useEffect(() => {
    if (!accessToken) return; // Skip WebSocket connection if no token
  ...
  const getSupplierLocation = useCallback(
    (supplier, realtimeSuppliers) => {
      if (realtimeSuppliers[supplier.id]?.isActive) {
        return [
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-gray-600 mb-6">
            Please log in to view the map and track suppliers in real-time.
          </p>
          <Link
            to="/login"
            ...
            !suppliersError && (
              ...
              >
                ...
                <SupplierMarkers
                  ...
                  isRealtimeRecent={isRealtimeRecent}
                />

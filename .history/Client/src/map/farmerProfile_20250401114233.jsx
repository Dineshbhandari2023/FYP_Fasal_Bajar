...
const FarmerProfile = () => {
  ...
  // Redux state
  // Get the current user from the user slice instead of auth slice
  const { currentUser } = useSelector((state) => state.user);

  // If your Redux store structure is different, you might need to adjust this selector
  // For example, if the user is stored directly in the user slice:

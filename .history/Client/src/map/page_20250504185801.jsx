...
const Map = () => {
  ...
  const filteredSuppliers = suppliers?.filter((supplier) => {
    ...
    if (showRealtimeOnly) {
      return matchesSearch && supplier.SupplierDetail?.status === "active";
    }
  ...
  const liveData =
    selectedEntity?.id != null ? realtimeSuppliers[selectedEntity.id] : null;
          ...
          >
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="text-center mb-4 sm:mb-6">
                ...
                // And your coordinates / timestamp
                {entityType === "supplier" && liveData && (
                  <div className="mt-2 text-sm text-gray-700">
                    📍 {liveData.latitude.toFixed(6)},{" "}
                    {liveData.longitude.toFixed(6)}
                    <br />
                    ⏱️ {liveData.lastUpdated.toLocaleTimeString()}
                  </div>
                )}

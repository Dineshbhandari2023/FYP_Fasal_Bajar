            ...
            !suppliersError && (
              ...
              >
                ...
                {filteredSuppliers?.map((supplier) => {
                  const locationArray = parseLocation(
                    supplier.SupplierDetails?.currentLocation
                  );
                  if (!locationArray) {
                    console.warn(
                      ...
                      <Popup>
                        <div className="text-center p-1">
                          ...
                          <p className="text-xs text-gray-600">
                            Supplier -{" "}
                            {supplier.SupplierDetails?.currentLocation
                              ? `${supplier.SupplierDetails.currentLocation.latitude},${supplier.SupplierDetails.currentLocation.longitude}`

...
export default function BrowsePage() {
  ...
  if (selectedCategory) {
    filteredProducts = filteredProducts.filter(
      (p) =>
        p.productType && // you can also filter by productName if needed
  ...
  // Updated addToCart that saves to localStorage
  const addToCart = (product) => {
    // If the product is already in the cart, update its quantity instead of pushing again
    ...
    if (itemExists) {
      ...
      // If it’s a new product, initialize with quantity 1

...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { accessToken, user_data } = response.data.Result;

      // Store token and user based on rememberMe flag
      if (rememberMe) {
      ...
      console.error(err);
      setApiError(
        err.response?.data?.Result?.message || "Login failed. Please try again."
      );
    } finally {
      setLoading(false);
    }

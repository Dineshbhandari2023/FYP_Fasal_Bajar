...
const Register = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      ...
      <div className="relative z-10  w-full max-w-md bg-white px-10 py-3 rounded-md shadow-md">
        <h1 className="text-4xl font-sans font-semibold text-center text-gray-800 mb-3">
          Fasal Bajar
        </h1>

...
const Register = () => {
  ...
  // For file input we use a separate state variable
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          setErrors((prev) => ({
            ...prev,
            location: "Could not detect your location. Please enter manually.",
          }));
        }
      );
    } else {
      ...
      setErrors((prev) => ({
        ...prev,
        location: "Geolocation is not supported in your browser.",
      }));
    }
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Append file if exists; note: the field name "image" is expected by the backend
      if (profileImageFile) {
        data.append("image", profileImageFile);
      }

      // Dispatch the registerUser thunk with the FormData

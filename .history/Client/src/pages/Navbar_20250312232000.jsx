...
import { fetchCurrentUser } from "../Redux/slice/userSlice"; // updated import

const Navbar = ({ onMenuClick }) => {
  const dispatch = useDispatch();
  // Destructure from state.user; userInfo holds the current user's data
  const {
  ...
  useEffect(() => {
    // If a valid token exists, fetch the current user data
    if (accessToken) {

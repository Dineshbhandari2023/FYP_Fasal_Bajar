...
const Navbar = ({ onMenuClick }) => {
  ...
  useEffect(() => {
    ...
    if (storedToken) {
      // Since the token may have been stored using JSON.stringify, parse it
      try {
        storedToken = JSON.parse(storedToken);
      } catch (err) {
        // If parsing fails, use the stored token as-is
        console.error("Token parsing error, using raw token:", err);
      }

...
const Login = () => {
  ...
  return (
    <div className=" justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="justify-center text-center w-full max-w-md bg-[#E3E7E0] p-8 rounded-md shadow-md">
        <h2 className="text-lg font-medium text-center mb-6">Welcome back</h2>

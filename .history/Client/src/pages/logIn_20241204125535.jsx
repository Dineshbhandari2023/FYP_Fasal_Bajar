    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md bg-[#E3E7E0] p-8 rounded-md shadow-md">
        <h1 className="text-2xl font-semibold text-center mb-4">
          <span className="text-black font-roboto font-semibold tracking-wide text-4xl">
            Fasal Bajar
          </span>
        </h1>
        ...
        <form onSubmit={handleSignIn}>
          ...
          <button
            type="submit"
            className="w-full bg-black font-semibold text-xl text-white py-2 rounded-md hover:bg-green-700 transition"
          >
            Sign in
          </button>
        </form>

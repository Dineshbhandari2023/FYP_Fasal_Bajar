...
const Navbar = ({ onMenuClick }) => {
  ...
  useEffect(() => {
    ...
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAsInVzZXJuYW1lIjoidGVzdDEiLCJlbWFpbCI6InRlc3QxQGdtYWlsLmNvbSIsImlhdCI6MTc0MDk4NjM4NCwiZXhwIjoxNzQxMDcyNzg0fQ.4wI96H_WO8WHqsSx0Z3V92c7B4BSAv2s_I-6bcyyUpk";

...
import { connectMessageSocket } from "../sockets/messageSocket";
...
export function StartChatButton({ farmerId, supplierId, className = "" }) {
  ...
  const handleStartChat = async () => {
    ...
    try {
      ...
      // Create appropriate initial message based on entity type
      const initialMessage = farmerId
        ? `Hello, I'm interested in your farm products!`
        : `Hello, I'm interested in your delivery services!`;

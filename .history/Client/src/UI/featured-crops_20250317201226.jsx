  ...
  return (
    <section className="py-16 px-6">
      <div className="mx-auto max-w-7xl">
        <h2 className="text-3xl font-bold tracking-tight text-center mb-12">Featured Crops</h2>
              ...
              <div className="p-5">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-gray-600">{crop.description}</p>
                  </div>
                ...
                <div className="mt-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-gray-600">Farmer: {crop.farmer}</span>
                  </div>
                </div>

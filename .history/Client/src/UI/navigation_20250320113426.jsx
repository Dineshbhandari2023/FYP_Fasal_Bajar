      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Cart */}
            <Link to="/cart">
              <button className="relative p-2 rounded-full hover:bg-gray-100 hover:text-green-900 transition-colors">
            ...
            <div className="hidden md:flex items-center space-x-2">
              <Link
                to="/profile"
                className="px-4 py-2 rounded-md text-white hover:bg-green-200 hover:text-green-800 transition-colors font-medium"
              >
                Profile
              </Link>
              <button

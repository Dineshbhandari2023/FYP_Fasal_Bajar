    ...
    <footer className="border-t bg-white">
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/how-it-works" className="text-sm text-gray-500 hover:text-green-600">
                  How It Works
                </Link>
              </li>
              <li>
                <Link href="/farmers" className="text-sm text-gray-500 hover:text-green-600">
                  Our Farmers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/support" className="text-sm text-gray-500 hover:text-green-600">
                  Support
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 border-t pt-8 text-center">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} FasalBajar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )

      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
            <Link
              to="/browse"
              className="relative py-2 transition-colors hover:text-green-600 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-white after:transition-all hover:after:w-full"
            >
              Browse Crops
            </Link>
            <Link
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-2">
              <Link
                to="/profile"
                className="px-4 py-2 rounded-md text-gray-700 hover:bg-gray-100 transition-colors font-medium"
              >
                Profile
              </Link>
              <button

    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          {/* Desktop Navigation */}
          <motion.nav
            className="hidden md:flex items-center space-x-8 text-sm font-medium text-white"
          ...
          >
            ...
            {/* Mobile menu button */}
            <motion.button
              className="p-2 rounded-md text-white hover:bg-green-700 md:hidden"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            exit="exit"
          >
            <motion.div className="absolute top-16 left-0 w-full bg-white border-t border-b shadow-lg">

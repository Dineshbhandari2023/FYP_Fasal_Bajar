      ...
      <div className="relative mx-auto max-w-5xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Connect directly with local farmers and get fresh, seasonal crops delivered straight to your home. Support
            local agriculture and enjoy the freshest produce.
          </p>

...
import { Users, Truck, ShoppingBag, BarChart3, UserCheck, UserX, CheckCircle, XCircle } from "lucide-react"
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">Bangalore, Karnataka</td>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">{new Date("2023-06-15").toLocaleDateString()}</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">{new Date("2023-06-18").toLocaleDateString()}</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">Vikram Patel</td>
                    <td className="px-6 py-4 whitespace-nowrap">{new Date("2023-06-10").toLocaleDateString()}</td>
        ...
        {activeTab === "delivery" && (
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="p-6 border-b">
              <h2 className="text-xl font-semibold">Delivery Staff Management</h2>
            </div>
            <div className="p-6 overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">South Bangalore</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">Central Mumbai</td>
                    <td className="px-6 py-4 whitespace-nowrap">5</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">

...
const Order = () => {
  ...
  useEffect(() => {
    console.log("Order.jsx: isAuthChecked:", isAuthChecked);
    console.log("Order.jsx: userInfo:", userInfo);
    if (isAuthChecked && userInfo?.role === "Farmer") {
      console.log("Order.jsx: Fetching farmer orders");
      dispatch(fetchFarmerOrders());
    }
  }, [dispatch, isAuthChecked, userInfo]);
      ...
      <div className="flex-1 md:ml-64">
        ...
        <div className="p-4 md:p-6">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            {/* Empty State */}
            {!ordersLoading && !ordersError && paginatedItems.length === 0 && (

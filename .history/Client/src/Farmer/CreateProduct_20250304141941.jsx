  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
        <h2 className="text-2xl font-bold mb-4 sm:mb-0">Create Product</h2>
      </div>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <span className="mt-2 sm:mt-0 px-2 py-1 text-sm bg-green-100 text-green-800 rounded">
                    Active
                  </span>
                </div>
              ))}

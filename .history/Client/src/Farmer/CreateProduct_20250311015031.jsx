...
import { fetchProducts, createProduct } from "../Redux/actions/productActions"; // <-- your thunks
...
const CreateProduct = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.imageFile) {
      data.append("images", formData.imageFile); // single image file
    }

    // ✅ Dispatch createProduct thunk (no navigate here)

...
import React, { useState, useEffect } from "react";
import { useDispatch, useSelector } from "react-redux";
import { fetchMyProducts, createProduct } from "../Redux/slice/productSlice";
import { Upload } from "lucide-react";
...
const CreateProduct = () => {
  ...
  // Fetch the logged-in user's products on mount
  useEffect(() => {
    if (accessToken) {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(createProduct(data)).then((result) => {
      if (createProduct.fulfilled.match(result)) {
        ...
        setFormErrors({});
        dispatch(fetchMyProducts()); // Refresh the user's product list
      }
    });
  };

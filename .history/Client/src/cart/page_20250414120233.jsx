...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    if (paymentMethod === "Online Payment") {
      ...
      // Redirect to payment form with the total amount and product IDs as query parameters
      window.location.href = `/payment-form?amount=${total}&productIds=${JSON.stringify(
        productIds
      )}`;
    } else {

          ...
          {activeTab === "new" && (
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium">Upload Crop Images</label>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <p className="text-sm text-gray-600">
                        Freshly harvested organic tomatoes grown without pesticides.
                      </p>
                      <p className="text-sm mt-1">
                        <span className="font-medium">Stock:</span> 50 kg
                      </p>
                      <p className="text-sm">
                        <span className="font-medium">Listed on:</span> {new Date().toLocaleDateString()}
                      </p>
                    </div>
                  </div>
                  <div className="flex justify-between items-center">

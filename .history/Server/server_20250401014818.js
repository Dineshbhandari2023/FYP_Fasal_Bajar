...
const setupReviewSocket = require("./sockets/reviewSocket");
...
// Update the Socket.IO CORS configuration
const io = socketIo(server, {
  cors: {
    origin: process.env.CLIENT_URL || "http://localhost:5173", // Make sure this matches your frontend URL
    methods: ["GET", "POST"],
    credentials: true,
  },
});
...
// Make sure the Express CORS configuration also matches
app.use(
  cors({
    origin: process.env.CLIENT_URL || "http://localhost:5173", // Same as above

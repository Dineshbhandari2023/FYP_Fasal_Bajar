...
// In server.js or your payment controller file
app.post("/initiate-payment", async (req, res) => {
  ...
  let paymentData = {
    ...
    product_code: process.env.MERCHANT_ID, // e.g., "EPAYTEST"
  ...
  // Convert paymentData to URLSearchParams to send as form data in the POST body
  const params = new URLSearchParams(paymentData);

  try {
    const payment = await axios.post(process.env.ESEWAPAYMENT_URL, params, {

...
const io = socketIo(server, {
  cors: {
    origin: "https://05fc-2001-df7-be80-abf-00-3.ngrok-free.app", // Match frontend ngrok URL
    methods: ["GET", "POST"],
    credentials: true,
  },
});
...
app.use(
  cors({
    origin: "https://05fc-2001-df7-be80-abf-00-3.ngrok-free.app", // Frontend ngrok URL
    methods: ["GET", "POST", "PUT", "DELETE", "PATCH", "OPTIONS"],
    credentials: true,
    allowedHeaders: ["Authorization", "Content-Type"],
  })

...
module.exports.createUser = asyncHandler(async (req, res, next) => {
  ...
  // Create user. (Assuming password hashing is handled by a model hook.)
  ...
  // Generate token. (Assuming generateAccessToken takes the user ID.)
...
module.exports.getCurrentUser = asyncHandler(async (req, res, next) => {
  // At this point, the authentication middleware has already verified the token.

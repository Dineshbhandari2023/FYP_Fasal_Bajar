...
// Helper to read image file as buffer from disk
...
const registerUser = async (req, res, next) => {
  ...
  try {
    ...
    // If a file was uploaded, read its buffer from disk for profileImage
    let profileImage = null;
    if (req.file) {
      profileImage = getFileBuffer(req.file.path);
    }
...
const updateUser = async (req, res, next) => {
  ...
  try {
    ...
    if (req.file) {
      ...
      user.profileImage = newImageBuffer;
    }
    await user.save();

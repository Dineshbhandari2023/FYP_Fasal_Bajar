...
// Helper: construct the relative URL for the uploaded image
const getProfileImageUrl = (file) => {
  // file.filename is provided by multer's disk storage
  // Assuming your static files are served from the "public" directory,
  // and your upload folder is "public/data/uploads"
  return `/data/uploads/${file.filename}`;
};
...
const registerUser = async (req, res, next) => {
  ...
  try {
    ...
    // If a file was uploaded, store its relative URL for profileImage
...
const updateUser = async (req, res, next) => {
  ...
  try {
    ...
    // Update profileImage if a new file is uploaded
    if (req.file) {
      // Instead of reading file as buffer, we store the relative URL
      user.profileImage = `/data/uploads/${req.file.filename}`;
    }
    await user.save();

...
const createOrder = async (req, res, next) => {
  ...
  try {
    ...
    if (paymentMethod === "Online Payment") {
      // Call the /initiate-payment route on your server (ensure SERVER_URL is set correctly)
    ...
    // Ensure that we only attempt rollback if the transaction is still active.
    try {

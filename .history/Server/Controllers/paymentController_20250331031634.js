...
exports.initiatePayment = async (req, res) => {
  ...
  const transactionUuid = String(orderId);
  ...
  // Check with eSewa if the delimiter (comma) and order are correct.
  ...
  try {
    // Call the eSewa payment gateway using a POST request with query parameters
    ...
    if (paymentResponse.status === 200) {
      ...
      // Adjust this based on the actual structure of eSewa's response.
      const redirectUrl =
